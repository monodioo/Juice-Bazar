      ...
      <div class="row ">
        <form class="page-section card col-12 py-5 px-5" method="post">
          <div class="container">
            <div class="row mb-5">
              <div class="col">
                <div class="border border-warning p-4 rounded" role="alert">
                  Bạn đã có tài khoản? <a href="#">Bấm vào đây</a> để đăng nhập
                </div>
              </div>
            </div>
                ...
                <div class="p-3 p-lg-5 border">
                  ...
                  <div class="form-group row">
                    <div class="col-md-12">
                      ...
                      <input type="text" class="form-control" id="c_name" name="c_name" placeholder="Họ và Tên">
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="p-3 p-lg-5 border">
                      ...
                      <div class="input-group w-75">
                        <input type="text" class="form-control" id="c_code" placeholder="Mã khuyến mại" aria-label="Mã khuyến mại" aria-describedby="button-addon2">
                        <div class="input-group-append">
                          <button class="btn btn-outline-warning btn-sm" type="button" id="button-addon2">Áp dụng</button>
                        </div>
                      </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="p-3 p-lg-5 border">
                      <table class="table site-block-order-table mb-4">
                        ...
                        <tbody>
                          <tr>
                            <td>Nước dưa hấu<strong class="mx-2"> x </strong>1</td>
