      ...
      <div class="row px-0">
        <div
          ...
          class="carousel slide carousel-fade rounded carousel-wrap"
          data-ride="carousel"
        >
          <ol class="carousel-indicators">
            <li
              ...
              data-slide-to="0"
              class="active rounded-circle mr-2"
            ></li>
            <li
              data-target="#carouselExampleFade"
              data-slide-to="1"
        ...
        <div class="page-section main-section col">
          ...
          <div class="section-body row">
                        ...
                        <div class="col-8">
                          ...
                          <div class="juice-modal-description">
                            <div
                              ...
                              href="#collapseNutrition"
                              role="button"
                              aria-expanded="false"
                              aria-controls="collapseNutrition"
                              class="font-weight-bold"
                            >
                              Giá trị dinh dưỡng<i
            ...
            <div class="col-6 col-md-4 col-lg-2">
              <div
                class="card juice-card px-1 px-xl-4 pt-4 mt-3 mt-lg-0"
                data-toggle="modal"
              ...
              >
                ...
                />
                <div class="card-body">
                  <h6 class="card-title text-center">Water-melon</h6>
                  <p
