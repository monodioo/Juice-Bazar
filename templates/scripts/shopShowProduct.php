...
if ($_REQUEST["typeid"] == '0') {
    $sqlShowProduct = "SELECT * FROM Product JOIN Inventory ON Product.ProductId = Inventory.ProductId
                    ...
                    <div class="container p-4">
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                <div class="juice-modal-price mb-3" id="modalPrice330ml" style="display">
                                    <?php
                                        $sql330 = "SELECT * FROM Inventory WHERE ProductId = " . $row['ProductId'] . " AND CapacityId = 2";
                                        $rs330 = mysqli_query($con, $sql330);
                                        $row330 = mysqli_fetch_array($rs330);
                                        echo $row330['Price'] / 1000;
