<?php
$sqlHotProductId = "SELECT ProductId FROM OrderDetail
                        GROUP BY ProductId
...
while ($rowHotProductId = mysqli_fetch_array($hotProductId)) {
    ...
    $rowShowHotProduct = mysqli_fetch_array($showHotProduct);
    ?>

    <!-- MODAL -->
    <div class="modal fade" id="<?php echo 'a' . $rowShowHotProduct['ProductId']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content juice-modal ">
                <div class="modal-body">
                    <div class="container p-4">
                        <div class="row">
                            <div class="col-4">
                                <img src="<?php echo $rowShowHotProduct['Image'] ?>" alt="<?php echo $rowShowHotProduct['Name']; ?>" class="w-100" />
                            </div>
                            <div class="col-8">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <i class="fas fa-times close-icon" aria-hidden="true"></i>
                                </button>
                                <div class="juice-modal-title"><?php echo $rowShowHotProduct['Name']; ?></div>
                                <div class="juice-modal-price mb-3" id="modalPrice250ml">
                                    <?php echo $rowShowHotProduct['Price'] / 1000; ?>.000₫
                                </div>
                                <div class="juice-modal-price mb-3" id="modalPrice330ml" style="display:none">
                                    <?php echo $rowShowHotProduct['Price'] / 1000; ?>.₫
                                </div>
                                <div class="juice-modal-description">
                                    ...
                                    <div class="collapse show" id="collapseNutrition">
                                        <?php echo $rowShowHotProduct['Nutrition'] ?>
                                    </div>
                                    ...
                                    <div class="collapse" id="collapseProperties">
                                        <?php echo $rowShowHotProduct['Description'] ?>
                                    </div>
                                    <div class="mt-2">
                                ...
                                <form class="juice-modal-options mt-3 pl-3 py-0" name="formModal" method="post">
                                    <div class="row">
                                        <input type="hidden" name="productid" value="<?php echo $rowShowHotProduct['ProductId'] ?>">
                                        <input type="hidden" name="typeid" value="<?= $rowShowHotProduct['TypeId'] ?>">
                                        ...
                                        <div class="d-flex flex-row align-items-center justify-content-center px-3 py-0 mt-4 mt-lg-0 col-12 col-lg-auto juice-qty-pill">
                                            ...
                                            <div class="input-group" style="width: 80px;">
                                                ...
                                                <input type="text" class="form-control text-center juice-qty-input px-1" value="1" name="quantity" aria-label="Quantity">
    ...
    <div class="col-6 col-md-4 col-lg-2">
        <div class="card juice-card px-1 px-xl-4 pt-3 mt-4" data-toggle="modal" data-target="<?php echo '#a' . $rowShowHotProduct['ProductId']; ?>">
            <img src="<?php echo $rowShowHotProduct['Image'] ?>" class="card-img-top" alt="<?php echo $rowShowHotProduct['Name']; ?>" />
            <div class="card-body">
                <h6 class="card-title text-center"><?php echo $rowShowHotProduct['Name'] ?></h6>
