            ...
            <table class="table table-hover table-striped" id='prodEditTable'>
                ...
                <tbody class="table-body">
                    ...
                    <tr>
                        ...
                        <td colspan="6">
                            <a class="admin-link" href="member-edit.php?id=<?= $orders[0]['MemberId'] ?>"><?= $orders[0]['MemberName'] ?></a>
                        </td>
                    </tr>
                    <tr>
                        <td scope="col">Order Date</td>
                        <td colspan="6">
                            <?= date_format(date_create($orders[0]['PurchaseDate']), 'd-m-Y H:i A T') ?>
                            <input type="hidden" name="PurchaseDate" value="<?= $orders[0]['PurchaseDate']; ?>"></td>
                    </tr>
                    <tr>
                    ...
                    <?php foreach ($orders[0]['Items'] as $item) : ?>
                        <?php ++$_SESSION['productCount']; ?>
                        <tr class="product-item">

                            <td class="align-middle">
                                <a href="products-edit.php?id=<?= $item['ProductId'] ?>"><?= $item['Name'] ?>&nbsp;(<?= $item['CapacityId'] - 1 ? "330ml" : "250ml" ?>)</a>

                            </td>
                            <td><select name="newProduct[<?= $_SESSION['productCount']  ?>][ProductDetailId]" class="custom-select product-select">
                            ...
                            <td class="align-middle">
                                <span class="product-price"><?= number_format($item['SalePrice'], 0, ",", ".") ?></span> ₫
                                <input class="product-price-input" type="hidden" name="newProduct[<?= $_SESSION['productCount']  ?>][SalePrice]" value='<?= $item['SalePrice'] ?>'>
                            </td>
                            <td>
                                <input type="number" min=1 max=100 class="form-control product-quantity" name="newProduct[<?= $_SESSION['productCount']  ?>][Quantity]" value="<?= $item['Quantity']; ?>">
                            </td>
                    ...
                    <tr>
                        ...
                        <td colspan="7" class="text-center"><a class="btn btn-primary btn-link text-white" id="addProductBtn">Add more Item</a></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="6">
                            ...
                            <input type="hidden" name="OldStatus" value="<?= $orders[0]['Status'] ?>">
                        </td>
                    </tr>
                    <tr>
                        <td scope="col">Action</td>
                        <td colspan="6"><button class="btn btn-warning text-white" type="submit" name="EditOrderBtn">Save</button>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <!-- <form method="post" action="../include/snippets/orders-delete.php">
