        ...
        <table class="table-order table table-hover table-sm table-responsive tablesorter" id='orderTable'>
            <thead>
                <tr>
                    ...
                    <th scope="col" style="width:10%" class="sorter-false filter-false">Change Status</th>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($orders as $order) : ?>
                    <tr>
                        ...
                        <td><?= date_format(date_create($order['DeliveryDate']), 'M-d-Y H:i') ?></td>
                        <td colspan=4 class="text-center align-middle p-0"><a href="#" class="toggle admin-link d-block h-100 py-3">
                        ...
                        <td>
                            <form method="POST" action="orderStatusSwitch.php">
                                <select class="custom-select" name="newStatus">
                                    ...
                                    <option value="3" <?= $order['Status'] >= 3 ? 'disabled' : '' ?>>3.Successful</option>
